...
def main():
    ...
    if json_mtow_kg != py_mtow_kg:
        mismatches.append(f"MTOW Mismatch: PARAMETERS.json={json_mtow_kg}kg, constants.py={py_mtow_kg}kg")
    if json_l_mm != py_l_mm:
        mismatches.append(f"Length Mismatch: PARAMETERS.json={json_l_mm}mm, constants.py={py_l_mm}mm")

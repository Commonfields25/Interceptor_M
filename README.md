...
Interceptor_M uses a multi-agent governance model with 11 gates (G0-G11) and is designed for **ISO 9001/27001 readiness**.

### ISO Readiness & Protection
- [QUALITY_MANAGEMENT_SYSTEM.md](./governance/QUALITY_MANAGEMENT_SYSTEM.md) - **ISO 9001 Framework**
- [SECURITY_POLICY.md](./governance/SECURITY_POLICY.md) - **ISO 27001 Information Security**
- [DATA_PROTECTION_PLAN.md](./governance/DATA_PROTECTION_PLAN.md) - Defense (DD) Data Protection
- [AUTO-APPROVAL-POLICY.md](./governance/AUTO-APPROVAL-POLICY.md) - Threshold-based auto-approval
